...
Original file is located at
    https://colab.research.google.com/drive/1zlmeLurBI1HLjLGHgQbwqFheJA7DN_B2
"""

"""
My News Button 📰
Checkboxes + Custom Topic Support - Final Working Version
"""
...
with st.sidebar:
    ...
    if st.button("Add Custom Topic", use_container_width=True):
        if custom_input.strip():
            cleaned = custom_input.strip()
            if cleaned not in selected_topics:
                selected_topics.append(cleaned)
...
if fetch_clicked:
    ...
    st.info("Select topics from the sidebar and click the button above.")
